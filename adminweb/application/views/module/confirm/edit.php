...
<div class="page-content">
	<div class="content">
		...
		<form class="main-form" method="post" action="<?php echo base_url(); ?>module/confirm_process/edit/<?php echo $id; ?>" enctype="multipart/form-data">
				...
				<div class="span12">
					<div class="grid simple">
						...
						<ul class="nav nav-tabs" id="main-tab">
							<li class="active"><a href="#tabs-detail">Confirmation Detail</a></li>
						</ul>
