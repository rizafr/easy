...
<div class="page-content">
	<div class="content">
		<div class="page-title">
			<h3>User - <span class="semi-bold">Add</span></h3>
		</div>
		<form class="main-form" method="post" action="<?php echo base_url(); ?>user/user_process/add">
			<div class="row-fluid">
				<div class="span12">
								...
								<div class="span6">
									<div class="row-fluid">
										<div class="span12">
											...
											<div class="row-fluid">
												<div class="span11">
													<input type="text" name="full_name" id="full_name" placeholder="Full Name" class="span12" value="" />
									...
									<div class="row-fluid">
										<div class="span12">
											...
											<div class="row-fluid">
												<div class="span11">
													<input type="text" name="email" id="email" placeholder="Email" class="span12" value="" />
								...
								<div class="span6">
									<div class="row-fluid">
										<div class="span12">
											...
											<div class="row-fluid">
												<div class="span11">
													<input type="text" name="username" id="username" placeholder="Username" class="span12" value="" />
											...
											<div class="row-fluid">
												<div class="span12">
													<select name="level" class="select" style="width:100%">
														...
														<option value="<?php echo $value->user_level_id; ?>"><?php echo $value->level; ?></option>
														<?php } ?>
														<?php } ?>
													</select>
												</div>
