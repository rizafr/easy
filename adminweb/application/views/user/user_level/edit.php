...
<div class="page-content">
	<div class="content">
		...
		<form class="main-form" method="post" action="<?php echo base_url(); ?>user/user_process/edit_level/<?php echo $id; ?>">
								...
								<div class="span12">
									<div class="row-fluid">
										<div class="span12">
											...
											<div class="row-fluid">
												<div class="span11">
													<input type="text" name="level" id="level" placeholder="Level Name" class="span12" value="<?php echo $detail->level; ?>" />
