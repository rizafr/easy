				...
				<div class="row" style="margin-top: 115px;">
					...
					<div class="col-sm-6">
						<div class="subheader-titles">
							<h2 class="subheader-maintitle"><?php echo $breadcrumb->menu?></h2>
						</div>
					</div>
				</div>
			</div>
...
<section class="hg_section ptop-10 pbottom-50">
	<div class="container">
		<div class="row">
		<div class="col-md-2"></div>
			<div class="col-md-12">
						<div class="th-spacer clearfix" style="height: 90px;"></div>
									...
									if ($value['menu_type'] === 'top')
									{
										if (is_array($value['children'])) {
											foreach ($value['children'] as $key => $content) {
												if($content['image']) $image = base_url().'uploads/images/article/full/'.$content['image'];
												else $image = base_url().'assets/images/default.jpg';
												?>	
												<div class="col-sm-6 col-lg-4 post"><a href="<?php echo base_url().$content['guid'];?>" class="hoverBorder plus"><span class="hoverBorderWrapper"><img src="<?php echo $image; ?>" class="img-responsive" alt="" height="200" width="370"><span class="theHoverBorder"></span></span><h6>Read more +</h6></a><em><?php //echo $content['title'];?></a></h3><em><?php echo $page_detail->content[$this->language_id]->created_date_short; ?></em>
				                                    <h3 class="m_title"><a href="<?php echo base_url().$content['guid'];?>"><?php echo $content['title'];?></a></h3>
				                                </div>	                                
